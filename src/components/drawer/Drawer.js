    ...
    return (
        <div className='drawer'>
            ...
            <div className="drawer-details">
                ...
                <Link onClick={()=> setDrawer(false)} to={'/'} className="drawer-items" style={{borderRight:location.pathname == "/technology"?"solid 10px white":null}}>03<span className="item-name">TECHNOLOGY</span></Link>
            </div>
        </div>
    );
}
